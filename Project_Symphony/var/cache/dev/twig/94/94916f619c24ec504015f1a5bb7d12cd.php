...
class __TwigTemplate_a26950b9f14506021976af8dff49141c extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 3, $this->source); })()), "id", [], "any", false, false, false, 3)) ? ("Edit") : ("New"));
        yield " Reclamation";
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>";
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 6, $this->source); })()), "id", [], "any", false, false, false, 6)) ? ("Edit") : ("New"));
        yield " Reclamation</h1>
    ...
    ";
        ...
        <button class=\"btn\">";
        // line 10
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10)) ? ("Update") : ("Create"));
        yield "</button>
    ";
        // line 11
...
";
    ...
    {
        return array (  124 => 13,  119 => 11,  115 => 10,  111 => 9,  107 => 8,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}{{ reclamation.id ? 'Edit' : 'New' }} Reclamation{% endblock %}

{% block body %}
    <h1>{{ reclamation.id ? 'Edit' : 'New' }} Reclamation</h1>

    {{ form_start(form) }}
        {{ form_widget(form) }}
        <button class=\"btn\">{{ reclamation.id ? 'Update' : 'Create' }}</button>
    {{ form_end(form) }}

    <a href=\"{{ path('reclamation_index') }}\">Back to list</a>
{% endblock %}
", "Reclamation/edit.html.twig", "C:\\Users\\Med\\Desktop\\Project_Symphony\\templates\\Reclamation\\edit.html.twig");
    }
}
