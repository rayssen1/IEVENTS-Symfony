 ...
 */
final class Version20250414091630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE eventspeaker CHANGE description description LONGTEXT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE dateReclamation dateReclamation DATETIME NOT NULL, CHANGE rate rate NUMERIC(10, 2) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation ADD CONSTRAINT FK_CE6064042C6A49BA FOREIGN KEY (idEvent) REFERENCES evenement (id)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX fk_event ON reclamation
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_CE6064042C6A49BA ON reclamation (idEvent)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reponse CHANGE idRec idRec INT DEFAULT NULL, CHANGE message message LONGTEXT NOT NULL, CHANGE messageRec messageRec VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reponse ADD CONSTRAINT FK_5FB6DEC7454DD7AB FOREIGN KEY (idRec) REFERENCES reclamation (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD event_id INT DEFAULT NULL, ADD total_price DOUBLE PRECISION NOT NULL, ADD created_at DATETIME NOT NULL, DROP eventId, DROP totalPrice, DROP createdAt, CHANGE id id INT NOT NULL, CHANGE userId userId INT DEFAULT NULL, CHANGE status status VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD CONSTRAINT FK_42C8495564B64DCC FOREIGN KEY (userId) REFERENCES user (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD CONSTRAINT FK_42C8495571F7E88B FOREIGN KEY (event_id) REFERENCES evenement (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE eventspeaker CHANGE description description TEXT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation DROP FOREIGN KEY FK_CE6064042C6A49BA
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation DROP FOREIGN KEY FK_CE6064042C6A49BA
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reclamation CHANGE dateReclamation dateReclamation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE rate rate DOUBLE PRECISION NOT NULL, CHANGE email email VARCHAR(500) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX fk_user ON reclamation (idUser)
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX idx_ce6064042c6a49ba ON reclamation
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reponse CHANGE message message TEXT NOT NULL, CHANGE messageRec messageRec VARCHAR(500) NOT NULL, CHANGE idRec idRec INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reponse ADD CONSTRAINT fk_reclamation FOREIGN KEY (idRec) REFERENCES reclamation (id) ON DELETE CASCADE
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD eventId INT NOT NULL, ADD totalPrice DOUBLE PRECISION DEFAULT NULL, ADD createdAt DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP event_id, DROP total_price, DROP created_at, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE userId userId INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE reservation ADD CONSTRAINT FK___user FOREIGN KEY (userId) REFERENCES user (id)
        SQL);
