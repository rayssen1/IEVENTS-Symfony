 ...
 */
final class Version20250405163822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD CONSTRAINT fk_organisateurId FOREIGN KEY (organisateurId) REFERENCES user (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE evenement ADD CONSTRAINT fk_event_speaker FOREIGN KEY (eventspeakerId) REFERENCES eventspeaker (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE id id INT NOT NULL, CHANGE state state VARCHAR(250) NOT NULL, CHANGE phone_number phone_number VARCHAR(255) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE state state VARCHAR(250) DEFAULT 'active' NOT NULL, CHANGE phone_number phone_number VARCHAR(255) DEFAULT NULL
        SQL);
    }
}
